...
public class ProducerWithCallbackConsoleDemo {
	static Logger logger = LoggerFactory.getLogger(ProducerWithCallbackConsoleDemo.class);
	...
	public static void main(String[] args) {
		...
		properties.setProperty(ProducerConfig.TRANSACTIONAL_ID_CONFIG, "tran-1");
